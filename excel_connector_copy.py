...
fullname = r'/Users/oneshpunchinilame/Desktop/Programming/stocks_react_app/Portfolio copy.xlsx'
...
def save_workbook():
    workbook_active_name  = active_book_check()
    xw.books['Portfolio copy.xlsx'].save()
    xw.books['Portfolio copy.xlsx'].close()
...
"""
new_portfolio = xw.books['Portfolio copy.xlsx']
